    ...
    <div id="herbal-craft-container" className="portfolio-container">
      ...
      <div className="portfolio-text-col">
        <div className="portfolio-text-section gsap-section-fade-up" ref={portfolioTextSectionRef}>
          <h3>Herbal Craft</h3>
          <p>
            Herbal Craft is a minecraft server; the website being used to offer online player count information using the MineTools API as well as linking to
            the store and discord.
          </p>
        </div>
        <div className="portfolio-text-section gsap-section-fade-up" ref={portfolioTextSectionRef}>
          <h3>Role</h3>
          <p>
            Web Developer / Designer - Building the project from initial concept designs, refining with input from the client, through to development and
            completion.
          </p>
        </div>
        <div className="portfolio-text-section gsap-section-fade-up" ref={portfolioTextSectionRef}>
          ...
          <div className="skills-container">
            <div className="skills-container-col-1">
              ...
              <div className="portfolio-skill">
                <img src={images.skillsCss} className="portfolio-skill-img" />
                <p className="portfolio-skill-text">CSS</p>
              </div>
