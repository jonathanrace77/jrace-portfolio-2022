...
import FallingBlockGame from "../falling-block-game/falling_block_game/FallingBlockGame.js";
          ...
          <div className="skills-container">
            <div className="skills-container-col-1">
              <div className="portfolio-skill">
                <img src={images.skillsReact} className="portfolio-skill-img" />
                <p className="portfolio-skill-text">React</p>
              </div>
              <div className="portfolio-skill">
                <img src={images.skillsJs} className="portfolio-skill-img" />
                <p className="portfolio-skill-text">JS</p>
              </div>
              <div className="portfolio-skill">
